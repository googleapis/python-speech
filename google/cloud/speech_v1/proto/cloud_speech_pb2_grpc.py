...
from google.cloud.speech_v1.proto import cloud_speech_pb2 as google_dot_cloud_dot_speech__v1_dot_proto_dot_cloud__speech__pb2
...
class Speech(object):
    ...
    def LongRunningRecognize(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/google.cloud.speech.v1.Speech/LongRunningRecognize',
